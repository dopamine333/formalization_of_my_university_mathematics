...
section I_How_multivariate_polynomials_are_defined
...
example : (3 * X 0 * X 1 ^ 2 : MvPolynomial (Fin 2) ℕ) =
  single (equivFunOnFinite.symm fun | 0 => 1 | 1 => 2) 3 := by
    simp [mul_assoc, single_eq_monomial, monomial_eq]

end I_How_multivariate_polynomials_are_defined

section II_Some_Isomorphism_between_MvPolynomials
...
end II_Some_Isomorphism_between_MvPolynomials


section III_The_number_of_permutations_is_equal_to_n!
...
end III_The_number_of_permutations_is_equal_to_n!
